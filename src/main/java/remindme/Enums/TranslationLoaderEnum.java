...
public class TranslationLoaderEnum {
    ...
    public enum TranslationKey {
        ...
        ENABLE_DISABLE_POPUP("EnableDisablePopup", "Enable / disable"),
        ACTIVE_POPUP("ActivePopup", "Active"),
        TOPLEVEL_POPUP("TopLevelPopup", "Show on top"),
